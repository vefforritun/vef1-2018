...
![](img/Depth-first-tree.svg "Mynd: https://en.wikipedia.org/wiki/File:Depth-first-tree.svg")

***

## Breadth first

![](img/Breadth-first-tree.svg "Mynd: https://en.wikipedia.org/wiki/File:Breadth-first-tree.svg")
...
[Dæmi um að færa til element](daemi/change.html)

[Dæmi um að búa til element](daemi/create.html)

[Dæmi um attribute](daemi/attribute.html)
