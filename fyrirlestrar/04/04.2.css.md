---
title: Fyrirlestur 4.2 — CSS 2 – Visual formatting og stuðningur við CSS
---

# Fyrirlestur 4.2 — CSS #2 – Visual formatting og stuðningur við CSS
...
* En hvað ef það eru ekki allir vafrar farnir að styðja? 😩
